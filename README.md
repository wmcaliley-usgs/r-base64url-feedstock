...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-base64url-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-base64url-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add r-base64url
# for installing globally
pixi global install r-base64url
```
...
It is possible to list all of the versions of `r-base64url` available on your platform:
...
```
pixi search r-base64url --channel conda-forge
```
